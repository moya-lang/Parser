...
class Json
{
    ...
    void print(std::string &content, Moya::ObjectTree &objectTree)
    {
        ...
        names[json.getData().id] = "json";
        names[object.getData().id] = "object";
        names[members.getData().id] = "members";
        names[pair.getData().id] = "pair";
        names[array.getData().id] = "array";
        names[elements.getData().id] = "elements";
        names[value.getData().id] = "value";
        names[whitespaces.getData().id] = "whitespaces";
        names[string.getData().id] = "string";
        names[character.getData().id] = "character";
        names[hexDigit.getData().id] = "hexDigit";
        names[number.getData().id] = "number";
        names[digit.getData().id] = "digit";
    ...
    public:
        ...
        int run()
        {
            ...
            Moya::Parser parser(json, stringSequencer, objectTree);
